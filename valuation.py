...
def dcf_fcff_scenarios(latest_fcff, shares_outstanding, net_debt=0.0,
    ...
    scenarios: dict 3 kịch bản {'Bi quan': {'wacc':..,'g':..}, ...}. Nếu
               không truyền, dùng mặc định chung (KHÔNG khuyến khích —
               nên tính WACC theo ngành qua sector_wacc.estimate_wacc()
               rồi build scenarios bằng sector_wacc.wacc_scenarios()).
